export const data = {
  ...
  skills: [
    ...
    //   name: 'Typescript',
    //   link: '',
    //   secondary: ['Material UI'],
    // },
    // {
    //   name: 'JavaScript',
    //   link: '',
    //   secondary: ['JQuery', 'JQuery UI', 'Ractive.js', 'RivetsJs'],
    // },
    // {
    //   name: 'React',
    //   link: '',
    //   secondary: ['React Router', 'Relay', 'NextJS', 'Remix', 'Chakra UI'],
    // },
    // {
    //   name: 'AngularJs',
    //   link: '',
    ...
    //   name: 'CSS3',
    //   link: '',
    //   secondary: ['SASS', 'LESS', 'tailwindcss', 'Bootstrap', 'Zurb Foundation'],
    // },
    // {
    //   name: 'GraphQL',
    //   link: '',
    ...
    //   name: 'Node.js',
    //   link: '',
    //   secondary: ['Express.js', 'HapiJs'],
    // },
    // {
    //   name: 'PHP',
    //   link: '',
    //   secondary: ['Laravel', 'Zend Framework'],
    // },
    // {
    //   name: 'C#',
    //   link: '',
    //   secondary: ['ASP.Net MVC', 'Entity Framework'],
    // },
    {
      name: 'Database',
      link: '',
      secondary: ['Postgres', 'MySQL', 'MSSQL', 'MongoDB'],
    },
    {
      name: 'ORM',
      link: '',
      secondary: ['Sequelize', 'Eloquent ORM', 'Doctrine'],
    },
    {
      name: 'Mobile',
      link: '',
    ...
    },
    {
      name: 'Cloud',
      link: '',
      secondary: ['Google Cloud', 'Azure', 'AWS'],
    },
    {
      name: 'Testing',
      link: '',
      secondary: ['Cypress', 'Nightwatch.js', 'Cucumber', 'Selenium', 'Jest', 'PHPUnit'],
    },
    {
      name: 'CI/CD',
      link: '',
      secondary: ['Octopus Deploy', 'TeamCity', 'Docker'],
    },
    {
      name: 'DevOps',
      link: '',
      secondary: ['Apache HTTPd', 'Linux', 'IIS'],
    },
    {
      name: 'DX Tooling',
      link: '',
      secondary: ['Nx', 'Turborepo'],
    },
    {
      name: 'Search',
      link: '',
