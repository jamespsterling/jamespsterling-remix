...
const experience = [
	{
		...
		description: [
			...
			"Champions DX improvements to help alleviate pain-points around hot-reload inefficiencies at scale, optimize test performance with <b>@swc/jest</b>, slow <b>Next.js</b> compile times, & 50x improvement in monorepo linting speed with <b>Biomejs</b>.",
			"Works to establish baseline <b>clean-code</b> concepts, importance of <b>type-safety</b>, & <b>separation-of-concerns</b> principals.",
			`Plays a key role in implementing event-driven back-end architecture using <b>Temporal</b> to both rebuild legacy software orchestration and prepare for highly scalable <a class="${linkStyles}" target='_blank' rel='noopener noreferrer' href='https://thinkaidium.com/mortgage-automation'>Automations Engine</a> & async background tasks processing achieving new levels of real-time observability as well as high throughput.`,
			"Leads effort to migrate from code-first to schema-first GraphQL API implementation using <b>GraphQL Codegen</b> & native <b>GraphQL.js</b> to improve troubled DX, reduce significant tech debt, and setup for future scale.",
		],
