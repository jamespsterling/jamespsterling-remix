...
const experience = [
  {
    ...
    description: [
      ...
      'Plays a key role in implementing event-driven back-end architecture using <b>Temporal</b> to both rebuild legacy software orchestration and prepare for highly scalable Automations Engine & async background tasks processing achieving new levels of real-time observability as well as high throughput.',
      'Leads effort to migrate from code-first to schema-first GraphQL API implementation using <b>GraphQL Code Generator</b> to improve troubled DX and reduce significant tech debt.',
    ],
