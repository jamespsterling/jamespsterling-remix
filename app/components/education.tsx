      ...
      <div className="education-block shadow-large">
        <div className="education-header">
          ...
          <div className="education-text-header">
            ...
            <h5>Scientific Concentration</h5>
          </div>
        </div>
        <span className="education-date">Aug 2005 - Dec 2010</span>
        <p>
          <b>Project: </b>Create a ride-sharing app to help link communities of students with others
          to work out riding sharing for economical purposes.
        </p>
      </div>
    </div>
  );
